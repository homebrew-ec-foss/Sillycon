...
This code includes adding an 8 fold symmetry with a moving graphic.
A few things like the single button toggle has not been implemented into this code.
...
Had a few road blocks at certain logical parts of the code.
Overall, I attempted to make a graphic visual using verilog, hope to implement the rest of the functionalities soon.
